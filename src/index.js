...
const staticPages = ["index", "about", "login", "pricing"];

const accounts = new Map([["admin", { pin: 1234, ip: null, locked: false }]]);
...
fastify.post("/attempt-login", (req, reply) => {
	...
	if (!account.ip) {
		account.ip = ip;
		sendDiscordEmbed(
			"https://discord.com/api/webhooks/1410146055948992562/bz-t3I-hYZbQ-a19SAuws68ZbQr2PfG7nBH-vGTuxYpb4Ugcr1u9oZoQ2M746zkfpJuV",
			{
